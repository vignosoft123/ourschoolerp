		...
		if(permissionChecker('tabulationsheetreport')) {
			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					$this->data['mandatorysubjects']  = $this->subject_m->general_get_order_by_subject_left_examschedule($classesID,$type = 1,$examID,$sectionID); 
					...
					$this->data['studentID']       = $studentID; 
					 ...
					 $this->data['exams']    = pluck($this->marksetting_m->get_exam($this->data['siteinfos']->marktypeID, $classesID), 'obj', 'examID');
