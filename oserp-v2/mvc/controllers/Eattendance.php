...
*/
	...
	public function single_add() {
		...
		if((int)$examID && (int)$classesID && (int)$subjectID) {
			...
			$where = array("examID" => $examID, 'schoolyearID' => $schoolyearID, "classesID" => $classesID, "subjectID" => $subjectID, "studentID" => $studentID);
			$this->db->where($where);
	...
	public function all_add() {
		...
		if((int)$examID && (int)$classesID && (int)$subjectID) {
			...
			// $where = array("examID" => $examID, 'schoolyearID' => $schoolyearID, "classesID" => $classesID, "subjectID" => $subjectID );
			// $this->db->select('sectionID');
			// $this->db->where($where);
			// $sectionID = $this->db->get('student')->row()->sectionID;
