    		...
    		<div class="row invoice-info">
    		    <div class="col-sm-4 invoice-col" style="font-size: 16px;">
    				...
    				<address>
    					...
    					<?=$this->lang->line("wesite"). " : ". $siteinfos->website?><br>
    				</address>
    		    ...
    		    <div class="col-sm-4 invoice-col" style="font-size: 16px;">
    	        	...
    	        	<address >
                        ...
                        <?php if(customCompute($student)) { echo $this->lang->line("invoice_phone"). " : ". $student->phone; } ?><br>
                    </address>
    		    </div>
    		    <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <table class="table table-bordered product-style">
                                        ...
                                        <td data-title="<?=$this->lang->line('invoice_feetype')?>">
                                            ...
                                            if(customCompute($invoices)) {
                                                foreach($invoices as $invoice) {
                                                    $totalinvamount+=$invoice->amount-$invoice->discount;
                                                }
                                            }
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="4"><?= convert_number($totalsubtotal, 2). ' Ruppes Only'?><span class="pull-right"><b><?=$this->lang->line('invoice_total')?> <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></b></span></td>
                               ...
                               <tr>
                                    <td colspan="4"><span class="pull-right">Balance <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></span></td>
                                    
                                    <td><b><?=number_format(($remainingBalance), 2)?></b></td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="row col-md-12">
                            <textarea name="remarks" id="remarks" class="form-control" rows=3 readonly></textarea>
                        </div>
                    </div>
                </div>
