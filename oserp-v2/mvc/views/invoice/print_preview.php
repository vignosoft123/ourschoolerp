...
<body>
  	<div>
	    ...
	    <table class="table table-bordered">
	      	...
	      	<tbody>
	          	<?php $subtotal = 0; $totalsubtotal = 0; $i = 1; if(customCompute($invoices)) { foreach($invoices as $invoice) { $discount = 0; if($invoice->discount > 0) { $discount = ($invoice->discount); } $subtotal = ($invoice->amount - $discount); $totalsubtotal += $subtotal;  ?>
		            <tr>
