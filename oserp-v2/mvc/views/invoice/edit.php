            ...
            <div class="box-body">
                ...
                <input type="text" class="form-control hidden" id="studentID" name="studentID" value="<?=set_value('studentID', $maininvoice->maininvoicestudentID)?>">
                    ...
                    <div class="classesDiv form-group <?=form_error('classesID') ? 'has-error' : '' ?>" >
                        <label for="classesID">
                            ...
                            <?php
                                ...
                                echo form_dropdown("classesID", $classesArray, set_value("classesID", $maininvoice->maininvoiceclassesID), "id='classesID' class='form-control select2' disabled");
                            ?>
                        <span class="text-red">
                    ...
                    <div class="classesDiv form-group <?= form_error('sectionID') ? 'has-error' : '' ?>">
                        ...
                        <?php
                            $sectionsArray = array('0' => $this->lang->line("invoice_select_sections"));
                            if(customCompute($sections)) {
                                foreach ($sections as $section) {
                                    $sectionsArray[$section->sectionID] = $section->section;
                                }
                            }
                            echo form_dropdown("sectionID", $sectionsArray, set_value("sectionID", $maininvoice->maininvoicesectionID), "id='sectionID' class='form-control select2' disabled");
                        ?>
                        <span class="text-red">
                    ...
                    <div class="dateDiv form-group <?=form_error('date') ? 'has-error' : '' ?>" >
                        <label for="date">
                            ...
                            <input type="text" class="form-control" id="date" name="date" value="<?=set_value('date', date('d-m-Y', strtotime($maininvoice->maininvoicedate)))?>"  auotocomplete ="off">
                        <span class="text-red">
