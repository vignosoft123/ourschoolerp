                ...
                <?php } elseif($sms == 1) { ?>
                    <form class="form-horizontal" role="form" method="post">
                        ...
                        ?>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="template_id" name="template_id" value="<?=set_value('template_id', $mailandsmstemplate->templ_id)?>" >
                            </div>
                            <span class="col-sm-4 control-label">
                ...
                <?php } elseif($voice == 1) { ?>
                    <form class="form-horizontal" role="form" method="post">
                        ...
                        ?>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="voice_name" name="voice_name" value="<?=set_value('voice_name', $mailandsmstemplate->name)?>" >
                            </div>
                            <span class="col-sm-4 control-label">
                        ...
                        ?>
                            ...
                            <div class="col-sm-4">
                                <?php
                                    ...
                                    echo form_dropdown("voice_user", $array, set_value("voice_user", $mailandsmstemplate->usertypeID), "id='voice_user' class='form-control'");
                                ?>
                            </div>
                            <span class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-8" >
                                <div class="col-sm-12 border" id="voice_tags">
                                    ...
                                    if(customCompute($usertypes)) {
                                        foreach ($usertypes as $key => $usertype) {
                                            if($usertype->usertypeID == 2) {
                                                echo '<div class="smstagdiv" id="'."voice_".$usertype->usertype.'">';
                                                    echo $teachers;
                                                echo '</div>';
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" style="resize: vertical;" id="voice_template" name="voice_template" ><?=set_value('voice_template', $mailandsmstemplate->template)?></textarea>
                            </div>
                            <span class="col-sm-3 control-label">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var voice_setuser = "<?=$voice_user?>";

        if(voice_setuser !='select') {
            <?php
                if(customCompute($usertypes)) {
                    foreach ($usertypes as $key => $usertype) {
                        echo 'if('.$usertype->usertypeID." == voice_setuser) {"."\n";
                            echo '$("#voice_'.$usertype->usertype.'").show();'."\n";
                        echo '} else {'."\n";
                            echo '$("#voice_'.$usertype->usertype.'").hide();'."\n";
                        echo '}'."\n"; 
                    }
                }
    ...
    $('.voicetagdiv > .voice_alltag').click(function() {
        var value = $(this).val();
        insertAtCaret("voice_template", value, 'id');
    });
