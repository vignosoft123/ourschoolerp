						...
						<div class="active tab-pane" id="profile">
							<div class="panel-body profile-view-dis">
								<div class="row">
									...
									<div class="profile-view-tab">
										<p><span>Alternative Phone1</span>: <?= $profile->alternative_phone1 ?></p>
									</div>
									<div class="profile-view-tab">
										<p><span>Alternative Phone2 </span>: <?= $profile->alternative_phone2 ?></p>
									</div>
									<div class="profile-view-tab">
										<p><span>Caste </span>: <?= $profile->caste ?></p>
									</div>
									...
									<div class="profile-view-tab">
										<p><span><?= $this->lang->line("student_village") ?> </span>: <?= $profile->village_name ?></p>
									</div>
									<div class="profile-view-tab">
										<p><span><?= $this->lang->line("mole1") ?> </span>: <?= $profile->mole1 ?></p>
									</div>
									<div class="profile-view-tab">
										<p><span><?= $this->lang->line("mole2") ?> </span>: <?= $profile->mole2 ?></p>
									</div>
									<div class="profile-view-tab">
										<p><span><?= $this->lang->line("aadharCardNumber") ?> </span>: <?= $profile->aadharCardNumber ?></p>
									</div>
								</div>
							</div>
						</div>
