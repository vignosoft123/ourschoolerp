                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php 
                        if(form_error('moles')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="moles" class="col-sm-2 control-label">
                            <?=$this->lang->line("moles")?>
                        </label>
                        <div class="col-sm-6">
                            <textarea type="text" class="form-control" id="moles" name="moles"> <?=set_value('moles', $student->moles)?>   </textarea>   
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('moles'); ?>
                        </span>
                    </div>
                    ...
                    <?php 
                        if(form_error('villageID')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="villageID" class="col-sm-2 control-label">
                            <?=$this->lang->line("student_village")?> <span class="text-red">* <?= $student->villageID;?></span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                            ...
                            ?>
                            <?php 
                                echo form_dropdown("villageID", $villagesArray, set_value("villageID", $student->villageID), "id='country' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
...
?>
    ...
    <div class="col-sm-6 <?= $this->input->post('studentType')=='1' || $student->studentType == '1' ? '' : 'hide'; ?> transport" >
        ...
        <?php
            ...
            echo form_dropdown("transportID", $array, set_value("transportID", $studntTransportDetails->transportID), "id='transportID' class='form-control select2'");
        ?>
    </div>
    ...
    ?>
        ...
        <div class="col-sm-6 <?= $this->input->post('studentType')=='1' || $student->studentType == '1' ? '' : 'hide'; ?> transport">
            <input type="text" class="form-control" id="tbalance" name="tbalance" value="<?=set_value('tbalance', $studntTransportDetails->tbalance); ?>" readonly>
        </div>
        <span class="col-sm-4 control-label <?= $this->input->post('studentType')=='1' || $student->studentType == '1' ? '' : 'hide'; ?> transport">
