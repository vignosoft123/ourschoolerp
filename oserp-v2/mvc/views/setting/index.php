    ...
    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('schoolCode') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="schoolCode"><?= $this->lang->line("setting_school_code") ?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set School Code"></i>
                                </label>
                                ...
                                <span class="control-label">
                                    <?php echo form_error('schoolCode'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('website') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="schoolCode">Website&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="website"></i>
                                </label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('school_telugu') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="schoolCode">School Telugu Name&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set School name in telugu"></i>
                                </label>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('isRandomAdmissionNumber') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="isRandomAdmissionNumber"><?= $this->lang->line("setting_school_random_admission_number") ?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="If u required random admission number while admitting student please check this"></i>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <input type="checkbox" class="form-control" id="isRandomAdmissionNumber" name="isRandomAdmissionNumber" value="1" <?= (isset($setting->isRandomAdmissionNumber) ?  ($setting->isRandomAdmissionNumber == 1 ? 'checked' : '') : '') ?>>
                                <span class="control-label">
                                    <?php echo form_error('isRandomAdmissionNumber'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('attendance_voice_notification')) {
                                                    echo 'has-error';
                                                } ?>">
                            <div class="col-sm-12">
                                <label><?= $this->lang->line("setting_attendance_voice_notification") ?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Select Attendance Voice Notification"></i>
                                </label>
                                <?php
                                $array = array(
                                    "none" => $this->lang->line("setting_none"),
                                ...
                                ?>
                                <span class="control-label">
                                    <?php echo form_error('attendance_voice_notification'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group <?php if (form_error('attendance_voice_notification_template')) {
                                                    echo 'has-error';
                                                } ?>" id="attendance_voice_notification_template_div">
                            <div class="col-sm-12">
                                <label><?= $this->lang->line("setting_attendance_voice_notification_template") ?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Select Attendance Voice Notification Template"></i>
                                </label>
                                <?php
                                $attendanceNotificationArray = array(
                                    "0" => $this->lang->line("setting_select_template"),
                                ...
                                if (customCompute($attendance_notification_templates1)) {
                                    foreach ($attendance_notification_templates1 as $attendance_notification_template) {
                                        $attendanceNotificationArray[$attendance_notification_template->mailandsmstemplateID] =  $attendance_notification_template->name;
                                    }
                                }
                                //print_r($setting->attendance_voice_notification_template);die;
                                ...
                                ?>
                                <span class="control-label">
                                    <?php echo form_error('attendance_voice_notification_template'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('teacher_present_time') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="schoolCode">Teacher Attendance Time &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set School name in telugu"></i>
                                </label>
                                ...
                                <span class="control-label">
                                    <?php echo form_error('teacher_present_time'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('is_biometric') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="is_biometric">Is Biometric &nbsp;
                                </label>
                                <label for="html">Yes</label> <input type="radio" id="yes" name="is_biometric" value="1" <?php if($setting->is_biometric == 1){echo "checked";}?>>
                                <label for="html">No</label><input type="radio" id="no" name="is_biometric" value="0" <?php if($setting->is_biometric == 0){echo "checked";}?>>

                                <!-- <input type="text" placeholder="Please enter 0 or 1" class="form-control" id="is_biometric" name="is_biometric" value="<?= set_value('is_biometric', isset($setting->is_biometric) ? $setting->is_biometric : '') ?>"> -->
                                <span class="control-label">
                                    <?php echo form_error('is_biometric'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?= form_error('is_fee_sms') ? 'has-error' : '' ?>">
                            <div class="col-sm-12">
                                <label for="is_fee_sms">Is Fee Sms &nbsp;
                                </label>
                                <label for="html">Enable</label> <input type="radio" id="yes" name="is_fee_sms" value="1" <?php if($setting->is_fee_sms == 1){echo "checked";}?>>
                                <label for="html">Disable</label><input type="radio" id="no" name="is_fee_sms" value="0" <?php if($setting->is_fee_sms == 0){echo "checked";}?>>
...
<script type="text/javascript">
    ...
    $(document).on('change', "#attendance_voice_notification", function() {
        var value = $(this).val();
        if (value == 'voicecall') {
            $("#attendance_voice_notification_template_div").show('slow');
        } else {
            $("#attendance_voice_notification_template_div").hide('slow');
        }
    });
