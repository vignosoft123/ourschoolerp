                ...
                <form class="form-horizontal" role="form" method="post">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="expensetypes" name="expensetypes" value="<?=set_value('expensetypes', $expensetypes->expensetypes)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="note" name="note"><?=set_value('note', $expensetypes->note);?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
