                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?php if($msg91 == 1) echo 'active'; ?>"><a data-toggle="tab" href="#msg91" aria-expanded="true">SMS</a></li>
                            <li class="<?php if($bulk == 1) echo 'active'; ?>"><a data-toggle="tab" href="#bulk" aria-expanded="true">Voice</a></li>
                            <li class="<?php if($bulk == 1) echo 'active'; ?>"><a data-toggle="tab" href="#whatsapp" aria-expanded="true"> Whatsapp </a></li>
                        </ul>
                                        ...
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            ?>
                                                <label for="bulk_username" class="col-sm-2 control-label">
                                                    Bearer Token <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_bulk)): ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group <?= form_error('msg91_username') ?'has-error':'' ?>" >
                                                <label for="msg91_username" class="col-sm-2 control-label">
                                                    Username <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_msg91)): ?>
                                                        <input type="text" class="form-control" id="msg91_username" name="msg91_username" value="<?=set_value('msg91_username')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="msg91_username" name="msg91_username" value="<?=set_value('msg91_username', $set_msg91['msg91_username'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('msg91_username'); ?>
                                                </span>
                                            </div>
                                            <div class="form-group <?= form_error('msg91_password') ?'has-error':'' ?>" >
                                                <label for="msg91_password" class="col-sm-2 control-label">
                                                    Password <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_msg91)): ?>
                                                        <input type="password" class="form-control" id="msg91_password" name="msg91_password" value="<?=set_value('msg91_password')?>" >
                                                    <?php else: ?>
                                                        <input type="password" class="form-control" id="msg91_password" name="msg91_password" value="<?=set_value('msg91_password', $set_msg91['msg91_password'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('msg91_password'); ?>
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group <?= form_error('msg91_register_school_name') ?'has-error':'' ?>" >
                                                <label for="msg91_register_school_name" class="col-sm-2 control-label">
                                                   Registered school Name<span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_msg91)): ?>
                                                        <input type="text" class="form-control" id="msg91_register_school_name" name="msg91_register_school_name" value="<?=set_value('msg91_register_school_name')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="msg91_register_school_name" name="msg91_register_school_name" value="<?=set_value('msg91_register_school_name', $set_msg91['msg91_register_school_name'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('msg91_register_school_name'); ?>
                                                </span>
                                            </div>


                                            <div class="form-group <?= form_error('msg91_PEID') ?'has-error':'' ?>" >
                                                <label for="msg91_senderID" class="col-sm-2 control-label">
                                                    PEID <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_msg91)): ?>
                                                        <input type="text" class="form-control" id="msg91_PEID" name="msg91_PEID" value="<?=set_value('msg91_PEID')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="msg91_PEID" name="msg91_PEID" value="<?=set_value('msg91_PEID', $set_msg91['msg91_PEID'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('msg91_PEID'); ?>
                                                </span>
                                            </div>
