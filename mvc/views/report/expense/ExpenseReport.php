                                ...
                                <?php
                                    ...
                                    foreach($expenses as $productpurchase) { ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('productpurchasereport_date')?>">
                                                <?=$productpurchase['uname'];?>
                                            </td>
                                            <td data-title="<?=$this->lang->line('productpurchasereport_date')?>">
                                                <?=$productpurchase['create_date'];?>
                                            </td>
                                            ...
                                            <td data-title="<?=$this->lang->line('productpurchasereport_total')?>">
                                                <?=number_format($productpurchase['amount'],2);?>
                                            </td>

                                            <?php 
                                                $total_amount += $productpurchase['amount'];
                                            ?>
