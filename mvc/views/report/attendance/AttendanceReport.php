        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <h5 class="pull-left"><?=$this->lang->line('attendancereport_class');?> : <?=isset($class) ? $class->classes :  'All Classes'?></h5>
                            <?php if($sectionID == 0) {?>
                        ...
                        <table id="example1" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <?php  if($classesID == 0 ) { ?>
                                        <th><?=$this->lang->line('attendancereport_class')?></th>
                                    <?php } ?>
                                    <?php  if($sectionID == 0 ) { ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php
                                            if($classesID == 0 ) { ?>
                                            <td data-title="<?=$this->lang->line('attendancereport_class')?>">
                                                <?=$student->srclasses; ?>
                                            </td>
                                        <?php } ?>
                                        <?php
