<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('add_title')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('college_name') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="college_name" name="college_name" value="<?=set_value('college_name')?>" >
                        </div>
                    ...
                    <div class="form-group <?=form_error('college_url') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="college_url" name="college_url" value="<?=set_value('college_url')?>" placeholder="https://example.com" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_college_group")?>" >
                        </div>
                    </div>
                </form>
            </div>
