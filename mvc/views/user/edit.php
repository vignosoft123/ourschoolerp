    ...
    <div class="box-body">
        <form class="ose-form-list taf-wrap" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="taf-section-body">
                    <div class="row">
                        <div class="col-md-4 form-group <?= form_error('name') ? 'has-error' : '' ?>">
                            <label for="name" class="control-label"><?=$this->lang->line("user_name")?> <span class="text-red">*</span></label>
                        ...
                        <div class="col-md-4 form-group <?= form_error('sex') ? 'has-error' : '' ?>">
                            ...
                            <?= form_dropdown("sex", array($this->lang->line("user_sex_male") => $this->lang->line("user_sex_male"), $this->lang->line("user_sex_female") => $this->lang->line("user_sex_female")), set_value("sex", $user->sex), "id='sex' class='form-control'") ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group <?= form_error('phone') ? 'has-error' : '' ?>">
                            <label for="phone" class="control-label"><?=$this->lang->line("user_phone")?></label>
                            <input type="text" class="form-control" id="phone" name="phone" value="<?=set_value('phone', $user->phone)?>" maxlength="10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group <?= form_error('usertypeID') ? 'has-error' : '' ?>">
                            ...
                            <?php
                                ...
                                echo form_dropdown("usertypeID", $array, set_value("usertypeID", $user->usertypeID), "id='usertypeID' class='form-control'");
                            ?>
                ...
                <div class="taf-section-body">
                    <div class="row">
                        <div class="col-md-4 form-group <?= form_error('photo') ? 'has-error' : '' ?>">
                            ...
                            <?php if (!empty($user->photo) && $user->photo != 'default.png'): ?>
                            <img id="taf-photo-preview" class="taf-preview-img"
                                 src="<?=base_url('uploads/images/'.$user->photo)?>"
                                 onerror="this.style.display='none'" alt="Current photo">
            ...
            <div class="taf-btn-row">
                <button type="submit" class="taf-submit-btn"><i class="fa fa-save"></i> <?=$this->lang->line("update_user")?></button>
            </div>
        </form>
    </div>
</div>
...
$(document).on('input', '#name, #religion, #address', function() {
...
$('.ose-form-list').on('submit', function(e) {
    ...
    if (ph && ph.length < 10) { svErr($f.find('#phone'), 'Phone must be 10 digits'); ok = false; }
