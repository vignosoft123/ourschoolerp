                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php 
                        if(form_error('expense')) 
                            echo "<div class='form-group has-error d-none' >";
                        else     
                    ...
                    <?php 
                        if(form_error('expensetypesID')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="expensetypesID" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                echo form_dropdown("expensetypesID", $array, set_value("userID"), "id='expensetypesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('expensetypesID'); ?>
                        </span>
                    </div>
                    ...
                    <?php 
                        if(form_error('expense_referenceno')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="expense_referenceno" class="col-sm-2 control-label">
                            Reference No (optional)
                        </label>
                        <div class="col-sm-6">
                            
                           <input type="text" class="form-control" id="expense_referenceno" name="expense_referenceno" value="<?=set_value('expense_referenceno')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('expense_referenceno'); ?>
                        </span>
                    </div>
