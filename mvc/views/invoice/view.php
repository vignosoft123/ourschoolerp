<?php if (customCompute($maininvoice)) { ?>
    <div class="well">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <button class="btn-cs btn-sm-cs" onclick="javascript:printDiv('printabledivWithoutBalance')"> <span class="fa fa-print"></span> <?= $this->lang->line('print') ?> Without Balance </button>
                <?php
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                    ...
                    <address>
                        ...
                        <?= $this->lang->line("website") . " : " . $siteinfos->website ?><br>
                    </address>
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                    ...
                    <address>
                        ...
                        <?php if (customCompute($student)) {
                            echo $this->lang->line("invoice_phone") . " : " . $student->phone;
                        } ?><br>
                    </address>
                </div><!-- /.col -->
                <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                        ...
                        <table class="table table-bordered product-style">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"><span class="pull-left"><?= convert_number($grandtotalandpayment['totalpayment'], 2). ' Ruppes Only'?></span><span class="pull-right"><b><?= $this->lang->line('invoice_paid') ?> <?= !empty($siteinfos->currency_code) ? '(' . $siteinfos->currency_code . ')' : '' ?></b></span></td>
    ...
    <div id="printabledivWithoutBalance" hidden>
        <section class="content invoice">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="page-header">
