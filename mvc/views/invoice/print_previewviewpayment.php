...
<body>
  	<div id="paymentDiv">
	          		...
	          		<table>
	            		<tbody>
			                ...
			                <?php if(customCompute($siteinfos)) { ?>
								...
								<tr>
			                        <td><?=$this->lang->line("website"). " : ". $siteinfos->website?></td>
			                    </tr>
			                <?php } ?>
	            		</tbody>
	          		</table>
	    ...
	    <table class="table table-bordered">
	      	...
	      	<tfoot>
                <tr>
                    <td colspan="4"><span class="pull-left"><?= convert_number($totalsubtotal, 2). ' Ruppes Only'?></span> <span class="pull-right"><b><?=$this->lang->line('invoice_total')?> <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></b></span></td>
				...
				<?php if($isShowBalance): ?>
					<tr>
						<td colspan="4">Balance <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></td>
						<!-- <td></td>
						<td></td>
						<td></td> -->
						<td><span class="pull-right"><b><?=number_format(round($remainingBalance), 2)?></b></span></td>
					</tr>
				<?php endif; ?>
            </tfoot>
	    </table>
