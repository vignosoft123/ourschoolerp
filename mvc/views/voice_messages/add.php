...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
            ...
            <?php echo $this->lang->line('voice_add'); ?>
        </h3>
        <ol class="breadcrumb pull-right" style="margin-top:5px;">
            ...
            <li class="active"><?php echo $this->lang->line('voice_add'); ?></li>
        </ol>
    </div>
    <div class="box-body">
        ...
        <form id="vmForm" method="post" action="<?php echo base_url('voice_messages/add'); ?>" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group <?php echo form_error('voice_name') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-6">
                    <input type="text" name="voice_name" class="form-control" value="<?php echo set_value('voice_name'); ?>" placeholder="Enter voice message name">
            ...
            <!-- Audio -->
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $this->lang->line('voice_audio_label'); ?> <span class="text-danger">*</span></label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    <button type="submit" class="btn btn-success" id="submitBtn">
                        <i class="fa fa-save"></i> <?php echo $this->lang->line('voice_save_btn'); ?>
                    </button>
