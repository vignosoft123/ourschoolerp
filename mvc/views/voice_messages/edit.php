...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-microphone"></i> <?php echo $this->lang->line('voice_edit'); ?></h3>
    </div>
    <div class="box-body">
        <form id="vmForm" method="post" action="<?php echo base_url('voice_messages/edit/' . $voice->id); ?>" enctype="multipart/form-data">
            ...
            <!-- Replace Audio (optional) Tabs -->
            <div class="form-group">
                <label>Replace Audio <span class="text-muted">(optional)</span></label>
            ...
            <button type="submit" class="btn btn-primary" id="submitBtn">
                <i class="fa fa-save"></i> Update Voice Message
            </button>
        </form>
    </div>
</div>
