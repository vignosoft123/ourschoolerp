        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title white-title bradcam-title text-uppercase text-center">
                    <h2><?= !empty($frontend->terms_label) ? htmlspecialchars($frontend->terms_label) : 'Terms &amp; Conditions' ?></h2>
            ...
            <div class="bradcam-wrap text-center">
                <nav class="bradcam-inner">
                    ...
                    <span class="bradcam-item active text-uppercase"><?= !empty($frontend->terms_label) ? htmlspecialchars($frontend->terms_label) : 'Terms &amp; Conditions' ?></span>
                </nav>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="terms-content" style="background:#fff; padding:40px; border-radius:6px; line-height:1.9; color:#444;">
                    ...
                    <h2 style="color:#333; margin-bottom:25px; font-size:26px; font-weight:700; text-transform:uppercase; border-bottom:3px solid #8dc63f; padding-bottom:12px;">
                        <?= !empty($backend->sname) ? htmlspecialchars($backend->sname) : '' ?> &ndash; TERMS &amp; CONDITIONS
                    </h2>

                    <div style="margin-bottom:28px;">
                        <h4 style="color:#8dc63f; margin-bottom:10px; font-size:16px; font-weight:700;">1. Acceptance of Terms</h4>
                        <p>By accessing or using the mobile application of <strong><?= !empty($backend->sname) ? htmlspecialchars($backend->sname) : '' ?></strong>, users (students, parents, staff) agree to comply with these Terms &amp; Conditions. If you do not agree, please do not use the app.</p>
                    </div>
                    ...
                    <div style="margin-bottom:28px;">
                        ...
                        <p>All content (logos, data, design) belongs to <strong><?= !empty($backend->sname) ? htmlspecialchars($backend->sname) : '' ?></strong>. Unauthorized copying or distribution is strictly prohibited.</p>
                    </div>
