                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?=form_error('admission_date') ? ' has-error' : ''  ?>">
                        <label for="admission_date" class="col-sm-2 control-label">
                            <?=$this->lang->line("onlineadmission_admission_date")?>
                        </label>
                        <div class="col-sm-6">
                            <?php $admission_date = ''; if($admissioninfo->admission_date) { $admission_date = date("d-m-Y", strtotime($admissioninfo->admission_date)); }  ?>
                            <input type="text" class="form-control" id="admission_date" name="admission_date" value="<?=set_value('admission_date', $admission_date)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?=form_error('admission_date'); ?>
                        </span>
                    </div>
