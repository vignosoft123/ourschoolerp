        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button onclick="javascript:location.href=<?=  base_url('global_payment');?>" type="button" class="btn btn-default" style="margin-bottom:0px;"  ><?=$this->lang->line('close')?></button>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button onclick="javascript:location.href=<?=  base_url('global_payment');?>"  type="button" class="btn btn-default flashClose" style="margin-bottom:0px;" data-dismiss="modal"><?=$this->lang->line('close')?></button>
                        </div>
