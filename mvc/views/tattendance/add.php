                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-2"><?= $this->lang->line('tattendance_address') ?></th>
                                    ...
                                    foreach ($teachers as $teacher) {
                                        if (isset($tattendances[$teacher->teacherID])) { ?>
                                            <tr>
                                                ...
                                                <td data-title="<?= $this->lang->line('tattendance_address') ?>">
                                                    ...
                                                    if (isset($tattendances[$teacher->teacherID])) {
                                                        if ($monthyear == $tattendances[$teacher->teacherID]->monthyear && $tattendances[$teacher->teacherID]->teacherID == $teacher->teacherID) {
                                                            ...
                                                            if ($tattendances[$teacher->teacherID]->$aday == "P") {
                                                                ...
                                                                $pmethod = "checked";
                                                                $ci =& get_instance();
                                                                $is_biomatric = $ci->get_settings('is_biometric');//check biometric yer or no
                                                                if($is_biomatric == 1){
                                                                    $amethod = "checked";
                                                                }
