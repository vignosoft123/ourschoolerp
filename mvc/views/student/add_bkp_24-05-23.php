...
<?php
    if (form_error('village'))
        ...
        echo "<div class='form-group' >";
    ?>
    <label for="village" class="col-sm-2 control-label">
        <?= $this->lang->line("student_village") ?><span class="text-red">*</span>
    </label>
    <div class="col-sm-6">
        <?php
        $villagesArray = array('' => $this->lang->line("student_select_village"));
        if ($villages != "empty") {
            foreach ($villages as $village) {
                $villagesArray[$village->villageID] = $village->villageName;
            }
        }
        ?>
        <?php
        echo form_dropdown("villageID", $villagesArray, set_value("villageID"), "id='villageID' class='form-control select2'");
        ?>
    </div>
    <span class="col-sm-4 control-label">
        <?php echo form_error('villageID'); ?>
    </span>
</div>
...
<?php 
        if(form_error('hostelID')) 
            ...
            echo "<div class='form-group' >";
    ?>
        <label for="hostelID" class="col-sm-2 control-label  <?= $this->input->post('studentType')=='2' ? '' : 'hide'; ?> hostel">
            <?=$this->lang->line("hmember_hname")?> <span class="text-red">*</span>
        </label>
        <div class="col-sm-6  <?= $this->input->post('studentType')=='2' ? '' : 'hide'; ?> hostel">
            <?php
        ...
        <span class="col-sm-4 control-label <?= $this->input->post('studentType')=='2' ? '' : 'hide'; ?> hostel">
...
<?php 
    if(form_error('categoryID')) 
        ...
        echo "<div class='form-group' >";
?>
    <label for="categoryID" class="col-sm-2 control-label hostel  <?= $this->input->post('studentType')=='2' ? '' : 'hide'; ?>">
...
<?php 
    if(form_error('transportID')) 
        ...
        echo "<div class='form-group' >";
?>
    <label for="transportID" class="col-sm-2 control-label  <?= $this->input->post('studentType')=='1' ? '' : 'hide'; ?> transport" >
        <?=$this->lang->line("tmember_route_name")?> <span class="text-red">*</span>
    </label>
    <div class="col-sm-6 <?= $this->input->post('studentType')=='1' ? '' : 'hide'; ?> transport" >
    ...
    <span class="col-sm-4 control-label <?= $this->input->post('studentType')=='1' ? '' : 'hide'; ?> transport">
...
<?php 
        if(form_error('tbalance')) 
            ...
            echo "<div class='form-group' >";
    ?>
        <label for="tbalance" class="col-sm-2 control-label <?= $this->input->post('studentType')=='1' ? '' : 'hide'; ?> transport">
