...
class smssettings_m extends MY_Model {
	...
	function get_order_by_whatsapp() {
		$query = $this->db->get_where('smssettings', array('types' => 'whatsapp'));
		return $query->result();
	}
    ...
    function get_voice() {
		$query = $this->db->get_where('smssettings', array('types' => 'bulk','field_names' => 'bulk_username'));
