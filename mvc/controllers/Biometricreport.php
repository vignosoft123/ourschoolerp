...
class Biometricreport extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data["subview"]   = "report/overtime/BiometricReportView";
        $this->load->view('_layout_main', $this->data);
    }

    public function getBiometricReport()
    {
       // print_r($_POST);die;
        ...
        if (permissionChecker('overtimereport')) {
            if ($_POST) {
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    $this->data['overtimes'] = $this->Biometric_m->get_biometric_for_report($this->input->post());

                    $retArray['render'] = $this->load->view('report/overtime/BiometricReport', $this->data, true);
