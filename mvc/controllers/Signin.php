...
*/
	...
	public function index() {
        ...
        // $migrations = $this->run_migrations();
        //$migrations = $this->runDataMigration();  //latest migration method
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->data["subview"]         = "signin/index_new";
    ...
    public function signout()
    {
        ...
        if ( $this->data["siteinfos"]->frontendorbackend === 'YES' || $this->data['siteinfos']->frontendorbackend == 1 ) {
            ...
            redirect(base_url("signin/index_new"));
        }
    }
