...
*/
    ...
    public function index()
    {
        ...
        if ( $this->data['setting'] ) {
            if ( $_POST ) {
                ...
                $this->data['attendance_notification_templates1'] = $this->_templateManager1($this->input->post('attendance_voice_notification_template'));
                $rules = $this->rules();
                ...
                if ( $this->form_validation->run() == false ) {
                    ...
                    $array['is_student_auto_invoice'] = $this->input->post('is_student_auto_invoice') ?  $this->input->post('isRandomAdmissionNumber') : 0;
                ...
                $this->data['attendance_notification_templates1'] = $this->_templateManager1($this->data['setting']->attendance_notification);
    ...
    private function _templateManager1( $type )
    {
        return $this->mailandsmstemplate_m->get_order_by_mailandsmstemplate([ 'type' => $type='voice', 'usertypeID' => 3 ]);
    }
