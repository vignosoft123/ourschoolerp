...
*/
	...
	public function index() {
		...
		if((int)$id) {
			...
			if(isset($fetchClass[$id])) {
				...
				$this->data['subjects'] = $this->subject_m->general_get_order_by_subject_only_subjects(array('classesID' => $id));
	...
	public function unique_subject() {
		...
		if((int)$id) {
			...
			$subject = $this->subject_m->general_get_order_by_subject(array("subject" => $this->input->post("subject"), "classesID" => $this->input->post("classesID")));
