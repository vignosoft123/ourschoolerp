<?php
    ...
    {
        return anchor($uri, "<span class='fa fa-eye'></span>",
            "class='" . $class . " btn-xs' data-placement='top' data-toggle='tooltip' data-original-title='" . $name . "'");
    }
    ...
    function display_menu( $nodes, &$menu )
    {
        ...
        foreach ( $nodes as $key => $node ) {
            ...
            if ( permissionChecker($node['link']) || ( $node['link'] == '#' && $f ) ) {
                if ( $f && customCompute($node['child']) == 0 ) {
                    $f    = 0;
        ...
        <div class="headerArea">
            ...
            <div class="siteTitle">
                ...
                <address>
                    ...
                    <b><?= $CI->lang->line('topbar_phone') ?>:</b> <?= $siteinfos->phone ?><br/>
                    <b>Website:</b>  <?= $siteinfos->website ?>
                </address>
            </div>
        </div>
        <?php
