...
class Msg91
{
    ...
    public function send( $to, $message, $template_id=0 )
    {
        ...
        // $url = "https://smslogin.co/v3/api.php?username=".$this->username."&apikey=".$this->password."&senderid=".$this->senderID."&mobile=".$to."&message=".$message."&templateid=".$template_id; //sendin dynamic message

        $url = "https://smslogin.co/v3/api.php?username=" . $this->username .
