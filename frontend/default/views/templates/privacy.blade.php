            ...
            <div class="row">
                ...
                <div class="bradcam-wrap text-center">
                    <nav class="bradcam-inner">
                        ...
                        <span class="bradcam-item active text-uppercase">Privacy Policy</span>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="privacy-content" style="background:#fff; padding:40px; border-radius:6px; line-height:1.9; color:#444;">
                        ...
                        <p style="margin-bottom:28px;">
                            <strong>{{ $backend->sname }}</strong> is committed to protecting the privacy of its students, parents, staff, and all users of the school mobile application. This Privacy Policy describes how we collect, use, and safeguard your personal information.
                        </p>
